...
SELECT Vehicle_Type,FORMAT(AVG(Ride_Distance),'0.00') AS Avg_distance from OLA_DataSet
WHERE Booking_Status = 'Success'
...
ALTER COLUMN Customer_Rating VARCHAR(50) NULL
...
SELECT Vehicle_Type,FORMAT(AVG(Customer_Rating),'0.00') AS Avg_customer_rating from OLA_DataSet
GROUP BY Vehicle_Type
